 ...
 */
public class AdapterSessionNotify extends
        RecyclerView.Adapter<AdapterSessionNotify.ViewHolderSessionNotify>{
    ...
    public AdapterSessionNotify(Context context){
    ...
    public ViewHolderSessionNotify onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate
                (R.layout.custom_movie_box_office2, parent, false);
    ...
    public void onBindViewHolder(ViewHolderSessionNotify holder, int position) {
        ...
        holder.movieTitle.setText(currentSession.getRequestBy());
        holder.sidNotify.setText(currentSession.getStr());
        ...
        if(currentSession.getIsDenied()) {
            holder.imageStatusNotify.setImageResource(R.drawable.ic_highlight_remove_black_18dp);
            ...
            holder.imageStatusNotify.setImageResource(R.drawable.ic_check_circle_black_18dp);
        }
        else if(currentSession.getIsConfirmed()&& (currentSession.getIsCompleted())){
            holder.imageStatusNotify.setImageResource(R.drawable.ic_thumb_up_black_18dp);

        }
        else if(!(currentSession.getIsConfirmed())&& !(currentSession.getIsCompleted())){
            holder.imageStatusNotify.setImageResource(R.drawable.ic_history_black_18dp);
...
*/
    ...
    static class ViewHolderSessionNotify extends RecyclerView.ViewHolder {
        ...
        ImageView imageStatusNotify;

        RatingBar movieAudienceScore;

        public ViewHolderSessionNotify(View itemView) {
            super(itemView);
            sidNotify = (TextView) itemView.findViewById(R.id.sidNotify);
            //movieThumbnail = (ImageView) itemView.findViewById(R.id.movieThumbnailNotify);
            movieTitle = (TextView) itemView.findViewById(R.id.movieTitleNotify);
            movieReleaseDate = (TextView) itemView.findViewById(R.id.movieReleaseDateNotify);
            movieAudienceScore = (RatingBar) itemView.findViewById(R.id.movieAudienceScoreNotify);
            sessionRemarks = (TextView) itemView.findViewById(R.id.sremarksNotify);
            imageStatusNotify = (ImageView) itemView.findViewById(R.id.imageStatusNotify);
