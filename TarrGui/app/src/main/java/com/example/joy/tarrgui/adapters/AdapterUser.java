...
public class AdapterUser extends
        RecyclerView.Adapter<AdapterUser.ViewHolderBoxOffice> {

    //contains the list of movies
    private ArrayList<User> mListMovies = new ArrayList<>();
    ...
    public void setMovies(ArrayList<User> listMovies) {
    ...
    @Override
    public ViewHolderBoxOffice onCreateViewHolder(ViewGroup parent,
                                                  int viewType) {
        View view = mInflater.inflate
                (R.layout.custom_movie_box_office, parent, false);
    ...
    public void onBindViewHolder(ViewHolderBoxOffice holder, int position) {
        User currentUser = mListMovies.get(position);
        //one or more fields of the Movie object may be null since they are fetched from the web
        holder.movieTitle.setText(currentUser.getName());
        holder.movieReleaseDate.setText(currentUser.getEmailId());
        holder.skills.setText(currentUser.getSkills().toString());
        holder.accepted.setText(String.valueOf(currentUser.getNotiAccepted()));
        holder.declined.setText(String.valueOf(currentUser.getNotiDeclined()));
        holder.pending.setText(String.valueOf(currentUser.getNotiPending()));
        ...
        float audienceScore = currentUser.getRating();
        if (audienceScore == -1) {
...
*/
   ...
   static class ViewHolderBoxOffice extends RecyclerView.ViewHolder {
       ...
       TextView skills, accepted, declined, pending;
        ...
        public ViewHolderBoxOffice(View itemView) {
            ...
            accepted = (TextView) itemView.findViewById(R.id.textAccepted);
            declined = (TextView) itemView.findViewById(R.id.textDec);
            pending = (TextView) itemView.findViewById(R.id.textPend);
