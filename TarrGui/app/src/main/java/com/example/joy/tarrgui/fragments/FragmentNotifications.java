 ...
 */
public class FragmentNotifications extends Fragment implements SortListener,SessionNotifyListner
    ...
    private AdapterSessionNotify mAdapterNotify;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipeSessionNotify);
        mSwipeRefreshLayout.setOnRefreshListener(this);

        mRecyclerMovies = (RecyclerView) view.findViewById(R.id.listSessionNotify);
        //set the layout manager before trying to display data
        mRecyclerMovies.setLayoutManager(new LinearLayoutManager(getActivity()));
        mAdapterNotify = new AdapterSessionNotify(getActivity());
    ...
    public void onRefresh() {
        Toast.makeText(getActivity(),"Notifications refresh", Toast.LENGTH_LONG);
        new SessionTask(getActivity(),mRecyclerMovies).execute("");
    }

    @Override
    public void onSessionNotifyLoaded(ArrayList<Session> listSession) {
...
*/
            ...
            sessions = sessionServiceSearch.findByRequestToIgnoreCase(ActivityMain.epta);
            if (sessions.isEmpty()) {
                return false;
            } else {
        ...
        protected void onPostExecute(Boolean b)
        {
            ...
            onSessionNotifyLoaded(mListSession);
